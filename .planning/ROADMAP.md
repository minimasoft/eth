...
- ✅ **v6.1 LLM Call Logging & Viewer** — Phases 29-32 (shipped 2026-06-08)
...
- [x] **Phase 31: LLM Call API Endpoint** — GET /documents/{id}/llm-calls paginated endpoint (completed 2026-06-08)
...
| 31. LLM Call API Endpoint | v6.1 | 1/1 | Complete | 2026-06-08 |
