...
- [x] 35-01-PLAN.md — v7 extraction schema, HR system prompt, OpenRouterProvider methods, extract_events_v7_activity
...
- [x] 35-03-PLAN.md — DocumentProcessingV7Workflow, __init__.py re-exports, worker.py registration, integration tests
