...
Plans: 4/4 complete
Status: COMPLETE
Last activity: 2026-06-02 - Completed quick task 260602-gjq: improve workflow visibility - fix premature processed status, add reference/entity/chunk/word counts to API and UI
