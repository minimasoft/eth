-- Baseline (pre-Alembic) v6 schema. Fresh databases get this, then
-- "alembic upgrade head" applies 0001 (v7 event tables), 0002 (drop v6
-- tables) and 0003 (llm_provider + document.provider_id/model).
-- Do NOT add objects here that a migration already creates.
